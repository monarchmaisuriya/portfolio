		...
		return (
			<div id="contact" className="mx-auto bg-white container">
				<div className="container mx-auto pt-10 pb-20 text-center">
					...
					<div>
						<div className="p-4 md:p-10 mx-auto mt-10 max-w-4xl md:max-w-3xl text-white">
								...
								<div className="flex justify-evenly">
									<div className="grid grid-rows-2 grid-flow-col md:grid-cols-2 md:grid-rows-1 gap-4 w-full">
										<div className="contact-element gap-2">
											<input
												className="icon-button bg-black placeholder-gray-700 text-sm md:text-md rounded-md p-3 relative w-3/4 md:w-full h-10 md:h-12"
												type="text"
												name="Name"
								...
								<div className="mt-5">
									<div className="grid grid-cols-1 grid-flow-row">
										<div className="contact-element gap-2">
											<textarea
												rows={3}
												className="icon-button bg-black placeholder-gray-700 text-sm md:text-md rounded-md p-3 w-3/4 md:w-full h-24 md:h-32"
												type="text"
												name="Message"
